...
var Application = {
    ...
    createCameras: function (parameters) {
        ...
        me.camera.position.set( 100, 1000, 1500 );
    ...
    createObjects: function () {
        ...
        loader.load('obj/lucy/Lucy100k_slim.js', function (geometry) {
            ...
            addMesh( geometry, 0.75, 0, 0, 0, 0, 0, 0, new THREE.MeshPhongMaterial({
                ambient: 0xffffff,
                color: 0xffffff,
                specular: 0x000000,
                shininess: 100
    ...
    initDatGui: function () {
        ...
        folder.add(effectController, 'mesh').name('Show mesh').onFinishChange(function (value) {
    ...
    render: function () {
        ...
        me.objects.lightMesh.position.x = 700 * Math.cos( me.r );
        me.objects.lightMesh.position.z = 700 * Math.sin( me.r );
